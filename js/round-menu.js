...
var services_data = [{ name: "GRHF", icon: "resHumaines" }, { name: "Mng-Matériels", icon: "renovMateriel" }, { name: "HSE", icon: "hygSecurite" }, { name: "Sys-Inf", icon: "sysInformation" }, { name: "Finances", icon: "finance" }, { name: "AUDIT", icon: "audit" }, { name: "C.Gestion", icon: "controlGest" }];
...
function addService(serv, index) {
  ...
  service_bubble.click(serviceClick);        //ici double click je sais pas se qu'il fait 
}
